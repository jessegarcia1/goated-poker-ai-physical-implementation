...
"""
    Stripped down version of the PokerNetwork class suited for raspberry pi.
    
    Only the encode_state method is neccessary for making game decisions.
"""
class PokerNetworkRaspberryPi():
